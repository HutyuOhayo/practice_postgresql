	-- Добавляем ограничение для имени
	-- ALTER table culture_data.culture_palaces_clubs   
	--    ALTER COLUMN "data.general.name" SET NOT NULL;
	
	-- Добавил ограничение для адреса
	-- ALTER TABLE culture_data.culture_palaces_clubs
	--    ALTER COLUMN "data.general.address.fullAdress" SET NOT NULL;
	
	-- CREATE EXTENSION IF NOT EXISTS postgis;
	
	-- Оставил только Вологодскую область
	...
	--Преобразовал данные из таблицы  "data.general.address.mapPosition" в геометрию типа point, 
